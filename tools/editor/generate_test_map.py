...
class Editor:
    ...
    def add_creature(self, kind_name: str, space: str, tile: Tuple[int, int], age=0.0):
        execute_script(
            self.connection,
            './add_creature.sql',
            kind_name=f"'{kind_name}'",
...
def prototype_raising(destination_path: str, template_path: str):
    ...
    generate_farmland(
        ...
        objects={
            'l': lambda tile, farmland: editor.add_creature('lama', farmland, tile, age=14.0),
